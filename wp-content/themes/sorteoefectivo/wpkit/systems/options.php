...
* Options WPKit */
	...
	function wk_register_settings_options_wpkit() {
		...
		// Opciones
			...
			// Loader
			register_setting( 'wpkit-settings-group', 'wk_option_loader' );
			register_setting( 'wpkit-settings-group', 'wk_option_loader_background' );
			register_setting( 'wpkit-settings-group', 'wk_option_loader_color' );
			register_setting( 'wpkit-settings-group', 'wk_option_loader_timing' );
			register_setting( 'wpkit-settings-group', 'wk_option_loader_img' );
			...
			// Meta tags
				register_setting( 'wpkit-settings-group', 'wk_option_meta_applewebapp' );
				register_setting( 'wpkit-settings-group', 'wk_option_meta_applefullscreen' );
				register_setting( 'wpkit-settings-group', 'wk_option_meta_applestatusbarcolor' );
				register_setting( 'wpkit-settings-group', 'wk_option_meta_appleicon' );
				register_setting( 'wpkit-settings-group', 'wk_option_meta_applestartupimg' );

				// Windows
				register_setting( 'wpkit-settings-group', 'wk_option_meta_mscolor' );
				register_setting( 'wpkit-settings-group', 'wk_option_meta_mstileimg' );

				//RSS
				register_setting( 'wpkit-settings-group', 'wk_option_meta_rss' );

		// Librerias
			register_setting( 'wpkit-settings-group', 'wk_option_libraries_slick' );
			register_setting( 'wpkit-settings-group', 'wk_option_libraries_fancybox' );
		...
		// Analytics
				register_setting( 'wpkit-settings-group', 'wk_option_analytics' );

		// Libraries
			register_setting( 'wpkit-settings-group', 'wk_option_smoothscroll' );
			register_setting( 'wpkit-settings-group', 'wk_option_smoothscroll_timing' );
			register_setting( 'wpkit-settings-group', 'wk_option_smoothscroll_disntance' );
						...
						<div id="post-body-content">
							...
							<div class="wk-tabs-content-left">
								...
								<ul class="wk-tabs-list clearfix" data-tabgroup="first-tab-group">
									...
									<li><a href="#tab3"><i class="dashicons-before dashicons-info"></i> Librerías</a></li>
									<li><a href="#tab4"><i class="dashicons-before dashicons-screenoptions"></i> Widgets</a></li>
									<li><a href="#tab5"><i class="dashicons-before dashicons-shield-alt"></i> SEO</a></li>
									<li><a href="#tab6"><i class="dashicons-before dashicons-shield-alt"></i> Analytics</a></li>
									<li><a href="#tab7"><i class="dashicons-before dashicons-welcome-widgets-menus"></i> Contenidos</a></li>
									<li><a href="#tab8"><i class="dashicons-before dashicons-networking"></i> Redes</a></li>
									<li><a href="#tab9"><i class="dashicons-before dashicons-admin-appearance"></i> Apariencia</a></li>
									<li><a href="#tab10"><i class="dashicons-before dashicons-info"></i> Información</a></li>
								</ul>
								<section id="first-tab-group" class="wk-tabgroup">
									...
									<div id="tab1" class="wk-tab">
											<!--<div class="wk-tab-rows">
												...
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_color">Color del loader</label>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="color" name="wk_option_color" id="wk_option_color" value="<?php if( get_option( 'wk_option_color' ) ) : echo esc_attr( get_option('wk_option_color') ); else : echo '#000'; endif; ?>" class=""/>
													</div>
												</div>
											</div>-->
											<!--<div class="wk-tab-rows">
											...
											<div class="wk-tab-rows">
												<div class="wk-tab-header">
													<h2>Smooth scroll</h2>
													<p class="description">Añade un smoothscroll a todo el sitio</p>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2-e wk-col-data">
														<label for="wk_option_loader">Smooth scroll</label>
														<p class="description">Toma en cuenta que esta opción cargará TweenMax.min.js y ScrollToPlugin.min.js desde CDN.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="checkbox" name="wk_option_smoothscroll" id="wk_option_smoothscroll" value="1" <?php checked(1, get_option('wk_option_smoothscroll'), true); ?> class="wk-checkbox"/>
														<label class="wk-checkbox-label" for="wk_option_smoothscroll"><i></i></label>
													</div>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2-e wk-col-data">
														<label for="wk_option_loader">Timing</label>
														<p class="description">Inidca en milisegundos el tiempo que el scroll durará activo en cada pull.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="number" min="0" max="2" step="0.01" name="wk_option_smoothscroll_timing" id="wk_option_smoothscroll_timing" value="<?php echo esc_attr( get_option('wk_option_smoothscroll_timing') ); ?>" class="regular-text"/>
													</div>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2-e wk-col-data">
														<label for="wk_option_loader">Distancia</label>
														<p class="description">Inidca en pixeles la distancia del scroll en cada pull.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
													<input type="number" min="20" max="800" name="wk_option_smoothscroll_disntance" id="wk_option_smoothscroll_disntance" value="<?php echo esc_attr( get_option('wk_option_smoothscroll_disntance') ); ?>" class="regular-text"/>
													</div>
												</div>
											</div>
											<div class="wk-tab-rows">
												<div class="wk-tab-header">
													<h2>Loader</h2>
													<p class="description">Muestra un loader screen al cargar el sitio.</p>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_loader">Mostrar loader</label>
														<p class="description">Activa o desactiva el loading screen.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="checkbox" name="wk_option_loader" id="wk_option_loader" value="1" <?php checked(1, get_option('wk_option_loader'), true); ?> class="wk-checkbox"/>
														<label class="wk-checkbox-label" for="wk_option_loader"><i></i></label>
													</div>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_loader_background">Color de fondo</label>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="color" name="wk_option_loader_background" id="wk_option_loader_background" value="<?php if( get_option( 'wk_option_loader_background' ) ) : echo esc_attr( get_option('wk_option_loader_background') ); else : echo '#191919'; endif; ?>" class=""/>
													</div>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_loader_color">Color del loader</label>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="color" name="wk_option_loader_color" id="wk_option_loader_color" value="<?php if( get_option( 'wk_option_loader_color' ) ) : echo esc_attr( get_option('wk_option_loader_color') ); else : echo '#7d4989'; endif; ?>" class=""/>
													</div>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_loader_timing">Timing</label>
														<p class="description">Personaliza el tiempo que se mostrará en milisegundos, p.ej. 1500ms.<br> Si no se indica el sitio se mostrará una véz haya cargado.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="number" step="50" min="200" max="10000" name="wk_option_loader_timing" id="wk_option_loader_timing" value="<?php echo esc_attr( get_option('wk_option_loader_timing') ); ?>" class="regular-text" style="max-width: 76px;"/>
													</div>
												</div>
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_loader_img">Loader personalizado</label>
													</div>
													<div class="wk-col wk-col-2e wk-col-data upload-img">
											    		...
											    		<div class="wk_option_image_uploader_container" <?php echo $wk_hide_image; ?>>
										    				<img class="image_src" height="36" src="<?php echo get_option( 'wk_option_loader_img' ); ?>">
											    			<span class="dashicons-before dashicons-dismiss remove-image"></span>
											    		</div>
														<div class="flex-item wk_option_image_uploader_action" <?php echo $wk_hide; ?>>
														    <input style="display: none;" type="text" name="wk_option_loader_img" class="image_url regular-text" value="<?php echo esc_attr( get_option('wk_option_loader_img') ); ?>" >
											...
											<div class="wk-tab-rows">
												...
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_theme_color">Color de la barra superior de Android</label>
														<p class="description">Cambia el color (hexadecimal) de la barra superior en Chrome para android.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="color" name="wk_option_theme_color" id="wk_option_theme_color" value="<?php if( get_option( 'wk_option_theme_color' ) ) : echo esc_attr( get_option('wk_option_theme_color') ); else : echo '#000'; endif; ?>" class=""/>
													</div>
												</div>

												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_appleicon">Icono de IOS</label>
														<p class="description">Se mostrará como icono de app al agregar a la pantalla principal y al cargar el sitio desde el acceso directo.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data upload-img">
										    			...
										    			<?php endif; ?>
											    		<div class="wk_option_image_uploader_container" <?php echo $wk_hide_image; ?>>
										    				<img class="image_src" height="48" src="<?php echo get_option( 'wk_option_meta_appleicon' ); ?>">
											    			<span class="dashicons-before dashicons-dismiss remove-image"></span>
											    		</div>
														<div class="flex-item wk_option_image_uploader_action" <?php echo $wk_hide; ?>>
														    <input style="display: none;" type="text" name="wk_option_meta_appleicon" class="image_url regular-text" value="<?php echo esc_attr( get_option('wk_option_meta_appleicon') ); ?>" >
														    <button type="button" name="upload-btn" id="" class="upload-btn button-secondary">Añadir imagen</button>
														</div>
													</div>
												</div>
												...
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_applestartupimg">IOS startup image</label>
														<p class="description">Se mostrará al abrir el sitio desde el acceso directo en inicio. <br>Puede generar resultados inesperados.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data upload-img">
										    			...
										    			<?php endif; ?>
											    		<div class="wk_option_image_uploader_container" <?php echo $wk_hide_image; ?>>
										    				<img class="image_src" height="48" src="<?php echo get_option( 'wk_option_meta_applestartupimg' ); ?>">
											    			<span class="dashicons-before dashicons-dismiss remove-image"></span>
											    		</div>
														<div class="flex-item wk_option_image_uploader_action" <?php echo $wk_hide; ?>>
														    <input style="display: none;" type="text" name="wk_option_meta_applestartupimg" class="image_url regular-text" value="<?php echo esc_attr( get_option('wk_option_meta_applestartupimg') ); ?>" >
														    <button type="button" name="upload-btn" id="" class="upload-btn button-secondary">Añadir imagen</button>
														</div>
													</div>
												</div>
												...
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_applestatusbarcolor">Color de la barra superior de IOS</label>
														<p class="description">Cambia el color (hexadecimal) de la barra superior en iPhone.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="color" name="wk_option_meta_applestatusbarcolor" id="wk_option_meta_applestatusbarcolor" value="<?php if( get_option( 'wk_option_meta_applestatusbarcolor' ) ) : echo esc_attr( get_option('wk_option_meta_applestatusbarcolor') ); else : echo '#000'; endif; ?>" class=""/>
													</div>
												</div>

												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_mstileimg">Windows Tile Image</label>
														<p class="description">Mostrará un icono al añadir el sitio al menú de inicio en Windows. <br>Podría no funcionar correctamente.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data upload-img">
										    			...
										    			<?php endif; ?>
											    		<div class="wk_option_image_uploader_container" <?php echo $wk_hide_image; ?>>
										    				<img class="image_src" height="48" src="<?php echo get_option( 'wk_option_meta_mstileimg' ); ?>">
											    			<span class="dashicons-before dashicons-dismiss remove-image"></span>
											    		</div>
														<div class="flex-item wk_option_image_uploader_action" <?php echo $wk_hide; ?>>
														    <input style="display: none;" type="text" name="wk_option_meta_mstileimg" class="image_url regular-text" value="<?php echo esc_attr( get_option('wk_option_meta_mstileimg') ); ?>" >
														    <button type="button" name="upload-btn" id="" class="upload-btn button-secondary">Añadir imagen</button>
														</div>
													</div>
												</div>
												...
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_mscolor">Color del icono en el menú de inicio de Winows</label>
														<p class="description">Cambia el color (hexadecimal) de fondo en el menú de inicio en Windows.</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="color" name="wk_option_meta_mscolor" id="wk_option_meta_mscolor" value="<?php if( get_option( 'wk_option_meta_mscolor' ) ) : echo esc_attr( get_option('wk_option_meta_mscolor') ); else : echo '#000'; endif; ?>" class=""/>
													</div>
												</div>
											...
											<div class="wk-tab-rows">
												<div class="wk-tab-header">
													...
													<p class="description">Inclye meta etiquetas adicionales.</p>
												</div>
												<!--<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
												...
												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_applewebapp">Apple Web App</label>
														<p class="description">Incluye la metaetiqueta apple-mobile-web-app-capable</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="checkbox" name="wk_option_meta_applewebapp" id="wk_option_meta_applewebapp" value="1" <?php checked(1, get_option('wk_option_meta_applewebapp'), true); ?> class="wk-checkbox"/>
														<label class="wk-checkbox-label" for="wk_option_meta_applewebapp"><i></i></label>
													</div>
												</div>

												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_applefullscreen">Apple touch full screen</label>
														<p class="description">Incluye la etiqueta apple-touch-fullscreen</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="checkbox" name="wk_option_meta_applefullscreen" id="wk_option_meta_applefullscreen" value="1" <?php checked(1, get_option('wk_option_meta_applefullscreen'), true); ?> class="wk-checkbox"/>
														<label class="wk-checkbox-label" for="wk_option_meta_applefullscreen"><i></i></label>
													</div>
												</div>

												<div class="wk-tab-row wk-cols">
													<div class="wk-col wk-col-2e wk-col-data">
														<label for="wk_option_meta_rss">Feed de RSS</label>
														<p class="description">Incluye el Feed de RSS</p>
													</div>
													<div class="wk-col wk-col-2e wk-col-data">
														<input type="checkbox" name="wk_option_meta_rss" id="wk_option_meta_rss" value="1" <?php checked(1, get_option('wk_option_meta_rss'), true); ?> class="wk-checkbox"/>
														<label class="wk-checkbox-label" for="wk_option_meta_rss"><i></i></label>
													</div>
												</div>
									...
									<div id="tab3" class="wk-tab">
										<div class="wk-tab-rows">
											...
											<div class="wk-tab-row wk-cols">
												<div class="wk-col wk-col-2e wk-col-data">
													<label>Slick slide</label>
													<p class="description">Añade <a href="http://kenwheeler.github.io/slick/">Slick slide</a></p>
												</div>
												<div class="wk-col wk-col-2e wk-col-data">
													<input type="checkbox" name="wk_option_libraries_slick" id="wk_option_libraries_slick" value="1" <?php checked(1, get_option('wk_option_libraries_slick'), true); ?> class="wk-checkbox"/>
													<label class="wk-checkbox-label" for="wk_option_libraries_slick"><i></i></label>
												</div>
											</div>
											...
											<div class="wk-tab-row wk-cols">
												<div class="wk-col wk-col-2e wk-col-data">
													...
													<p class="description">Añade <a href="https://fancyapps.com/fancybox/3/">Fancybox 3</a></p>
												</div>
												<div class="wk-col wk-col-2e wk-col-data">
													<input type="checkbox" name="wk_option_libraries_fancybox" id="wk_option_libraries_fancybox" value="1" <?php checked(1, get_option('wk_option_libraries_fancybox'), true); ?> class="wk-checkbox"/>
													<label class="wk-checkbox-label" for="wk_option_libraries_fancybox"><i></i></label>
												</div>
											</div>
									...
									<div id="tab6" class="wk-tab">
										<div class="wk-tab-rows">
											<div class="wk-tab-header">
												<h2>Scripts de seguimiento</h2>
											</div>
											<div class="wk-tab-row wk-cols">
												<div class="wk-col wk-col-2e wk-col-data">
													<label for="wk_option_analytics">Analytics</label>
													<p class="description">Còdigo de Google analytics</p>
												</div>
												<div class="wk-col wk-col-2e wk-col-data">
													<textarea type="text" name="wk_option_analytics" id="wk_option_analytics" value="" class="regular-text" rows="8"><?php echo esc_attr( get_option('wk_option_analytics') ); ?></textarea>
												</div>
											</div>
										</div>
									</div><!--.wk-tab-->
